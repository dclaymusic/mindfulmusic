...
var hackOptions = {
	...
	audio: {
		...
		'aaz': { src: 'aaz.mp3', loop: true },
		'ar': { src: 'ar.mp3', loop: true },
		'cjt': { src: 'cjt.mp3', loop: true },
		'dle': { src: 'dle.mp3', loop: true },
		'kee': { src: 'kee.mp3', loop: true },
		'l': { src: 'l.mp3', loop: true },
		'm': { src: 'm.mp3', loop: true },
		'n': { src: 'n.mp3', loop: true },
		'nkzka': { src: 'nkzka.mp3', loop: true },
		'osn': { src: 'osn.mp3', loop: true },
		'slfc': { src: 'slfc.mp3', loop: true },
		'tl': { src: 'tl.mp3', loop: true },
